...
let paths = [
  ...
  "skyline", "comic", "ribbon", "wave", "footprint large",  "ice small"
];
let layer_1_indexes = [
  11, 34, 35, 2, 37, 38, 39, 40, 41, 43, 14, 23, 36, 3, 42
];
let layer_1_probabilities = [
  2, 4, 4, 4, 4, 4, 4, 4, 4, 4, 6, 11, 15, 15, 15
];
let layer_2_indexes = [
  0, 7, 2, 6, 5, 1, 3, 4
];
let layer_2_probabilities = [
  2, 7, 10, 10, 12, 14, 20, 25
];
let layer_3_indexes = [
...
let layer_4_indexes = [
  12, 8, 14, 9, 15, 11, 16, 13, 10
];
let layer_4_probabilities = [
  2, 4, 4, 10, 10, 15, 15, 18, 22
];
let layer_5_indexes = [
...
let layer_6_indexes = [
  20, 22, 18, 21, 17, 24, 80, 25, 19
];
let layer_6_probabilities = [
  2, 4, 5, 5, 8, 10, 15, 25, 26
];
let layer_7_indexes = [
...
let layer_8_indexes = [
  30, 29, 31, 32, 27, 28, 26, 33
];
let layer_8_probabilities = [
  2, 10, 10, 10, 12, 16, 20, 20
];
